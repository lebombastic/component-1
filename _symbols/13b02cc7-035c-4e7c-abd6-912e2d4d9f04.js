// Site Footer - Updated July 30, 2025
function noop() { }
function run(fn) {
    return fn();
}
...
function create_each_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*social*/ 2 && a_href_value !== (a_href_value = /*link*/ ctx[3].url)) {
				attr(a, "href", a_href_value);
			}

			if (dirty & /*social*/ 2 && a_aria_label_value !== (a_aria_label_value = /*link*/ ctx[3].label)) {
